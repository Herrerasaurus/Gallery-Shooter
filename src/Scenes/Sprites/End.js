class End extends Phaser.Scene{
    ...
    create(){
        ...
        const text = this.add.text(600, 300, 'Game Over', { align: 'center'});
        const score = this.add.text(600, 600, 'Score: ' + this.endScore, { align: 'center'});
        ...
        const button = this.add.text(500, 800, 'Home Screen', {
            fontFamily: 'Gothic',
            fontSize: '30px',
            color: '#f7f3e4',
            align: 'center',
